...
- J'essaye d'envoyer une commande Python: ```py
 print(1)```, mais aucun résultat. Je suppose donc qu'on doit jouer avec la requête pour trouver le bon point d'entrée.<br/>
